<template>
  <div class="doc-list">
    ...
    <DocumentProcessDialog v-model="processVisible" :record="currentRecord" @success="loadData" />
  </div>
</template>
...
import DocumentProcessDialog from './DocumentProcessDialog.vue'
...
const handleProcess = (row: DocumentItem) => {
  currentRecord.value = row
